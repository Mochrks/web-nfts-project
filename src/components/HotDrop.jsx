...
import { nft1,nft2,nft3,nft4,nft5,nft6,nft7,nft8,nft9,nft10 } from "../assets";
  ...
  className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} sm:flex-row flex-col bg-discount-gradient rounded-[20px] box-shadow`}>
    ...
    className={`${layout.sectionImg} flex-col`}>
        ...
        <div className="w-full flex sm:flex-row flex-col ">
            ...
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft4} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft5} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
        </div>
        
        <div className="w-full flex sm:flex-row flex-col ">
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft6} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft7} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft8} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft9} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
            <div className="w-full md:mt-10 mt-6 sm:mx-3 mx-1">
                <img src={nft10} alt="nft" className="w-[100%] h-[100%] relative z-[5]" />
            </div>
        </div>
